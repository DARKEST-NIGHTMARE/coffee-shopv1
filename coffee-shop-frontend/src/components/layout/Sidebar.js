...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      <div className="sidebar-header">Coffee Shop</div>
      <nav>
        <ul>
          <li>
            {" "}
          ...
          {hasPerm("ORDER_CREATE") && (
            <li>
              <NavLink to="/orders">Order Tab</NavLink>
            </li>
          )}
          <li>
          ...
          {hasPerm("MENU_MANAGE") && (
            <li>
              <NavLink to="/menu">Menu Mgt.</NavLink>
            </li>
          )}
          {hasPerm("INVENTORY_MANAGE") && (
            <li>
              <NavLink to="/inventory">Inventory Mgt.</NavLink>
            </li>
          )}
          ...
          {hasPerm("STAFF_MANAGE") && (
            <li>
              <NavLink to="/staff">Staff Mgt.</NavLink>
            </li>
          )}
          {hasPerm("ROLE_MANAGE") && (
            <li>
              <NavLink to="/roles">Roles & Perms</NavLink>
            </li>
          )}
        </ul>
      </nav>
